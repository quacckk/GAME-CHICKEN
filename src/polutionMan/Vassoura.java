...
public class Vassoura {
	...
	private BufferedImage imagemVassoura;

	public Vassoura(int largura, int altura) {
		...
		carregarImagemVassoura();
	}

	private void carregarImagemVassoura() {
		try {
			imagemVassoura = ImageIO.read(getClass().getResourceAsStream("/res/broom.png"));

			if (imagemVassoura == null) {
	...
	public void draw(Graphics2D g2) {
		if (ativa) {
			if (imagemVassoura != null) {
				g2.drawImage(imagemVassoura, x, y, largura, altura, null);
			} else {
